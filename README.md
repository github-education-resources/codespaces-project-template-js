...
You can access the live website at [(https://orange-cliff-0d2caf100.3.azurestaticapps.net/)](https://orange-cliff-0d2caf100.3.azurestaticapps.net/)]
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/lohitkolluri/codespaces-project-template-js 
   ```
